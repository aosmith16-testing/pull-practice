...
Using package **usethis** makes pull requests easy for the person proposing the edits.  However, first everyone has to get a GitHub PAT.

Otherwise there are several steps to keep track of.
